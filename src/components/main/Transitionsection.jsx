...
const TransitionSection = () => {
    ...
    useEffect(() => {
        ...
        // 1. 초기 세팅: 텍스트가 "작은 상태"로 미리 보이게 설정
        ...
        const raf = requestAnimationFrame(() => {
            ...
            // 2. Timeline 생성 (PorterToPotr 호흡 그대로)
            ...
            // ② 핵심: 맨 우측(R2)부터 역순으로 커지는 로직
            // letters 배열을 뒤집어서(reverse) 끝에서부터 애니메이션을 시작합니다.
            [...letters].reverse().forEach((el, i) => {
                // 실제 letters 배열에서의 원래 인덱스를 찾아야 정확한 originX를 가져옵니다.
